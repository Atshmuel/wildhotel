...
function Window({ children, name }: { children: ReactElement, name: string }) {
    ...
    return createPortal(
        <div className="fixed top-0 left-0 z-20 w-full h-full backdrop-blur-sm transition-all duration-500">
            <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-primary-900 text-primary-100  shadow-lg px-14 py-16 transition-all duration-500  md:w-1/2 w-11/12 " ref={ref}>
